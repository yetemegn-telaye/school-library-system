...
- [school-library-system](#school-library-system)
...
**school-library-system** school library system built with ruby following OOP.
...
```sh
  cd my-folder
  git clone https://github.com/yetemegn-telaye/school-library-system.git

  cd school-library-system.git
```
